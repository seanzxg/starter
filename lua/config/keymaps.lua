...
if vim.g.vscode then
    vim.keymap.set('n', "[b", "<Cmd>call VSCodeNotify('workbench.action.previousEditorInGroup')<CR>", opts)
    vim.keymap.set('n', "]b", "<Cmd>call VSCodeNotify('workbench.action.nextEditorInGroup')<CR>", opts)
